...
public class TopPrizesAdapter extends AbstractPreviewAdapter {
    private List<Prize> prizes;

    public TopPrizesAdapter(List<Prize> prizes) {
        super();
        this.prizes = prizes;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(getView(parent, R.layout.adapter_item_top_prize));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            prize = itemView.findViewById(R.id.imageTopPrize);
